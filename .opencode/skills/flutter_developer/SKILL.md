...
description: This document defines the technical architecture and development standards for the Quitra Flutter app. It mandates a **Clean Architecture** approach using a modern reactive stack and an **Offline-First** mindset.
---
