...
import 'package:quitra/core/di/injection.dart' as _i21;
...
import 'package:quitra/features/home/domain/usecases/save_daily_log.dart'
    as _i15;
import 'package:quitra/features/home/presentation/bloc/home_bloc.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i16.UpdateJourneyDay>(
        () => _i16.UpdateJourneyDay(gh<_i11.JourneyRepository>()));
    gh.factory<_i17.GetHomeStatsUseCase>(
        () => _i17.GetHomeStatsUseCase(gh<_i9.HomeRepository>()));
    gh.lazySingleton<_i18.GetJourneyHistory>(
        () => _i18.GetJourneyHistory(gh<_i11.JourneyRepository>()));
    gh.factory<_i19.HomeBloc>(() => _i19.HomeBloc(
          gh<_i17.GetHomeStatsUseCase>(),
          gh<_i13.LogCravingUseCase>(),
          gh<_i15.SaveDailyLog>(),
        ));
    gh.factory<_i20.JourneyBloc>(() => _i20.JourneyBloc(
          gh<_i18.GetJourneyHistory>(),
          gh<_i16.UpdateJourneyDay>(),
        ));
    return this;
  }
}
